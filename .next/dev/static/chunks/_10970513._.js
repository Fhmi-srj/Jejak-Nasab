...
function ExportTree({ treeContainerRef, baniName }) {
    ...
    // Helper: temporarily reset any CSS transforms before capture
    const captureTree = async ()=>{
        if (!treeContainerRef.current) throw new Error("No tree ref");
        // Find the scaled div inside and temporarily reset its transform
        const scaledDiv = treeContainerRef.current.querySelector("[style*='transform']");
        const originalTransform = scaledDiv?.style.transform || "";
        if (scaledDiv) {
        ...
        try {
            ...
            const canvas = await html2canvas(treeContainerRef.current, {
                ...
                windowWidth: treeContainerRef.current.scrollWidth + 100,
                windowHeight: treeContainerRef.current.scrollHeight + 100
            });
            return canvas;
        } finally{
            // Restore transform
            if (scaledDiv) {
                scaledDiv.style.transform = originalTransform;
            }
        }
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                disabled: exporting,
                className: "touch-target flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white border border-surface-200 text-surface-700 text-sm font-medium hover:bg-surface-50 transition-colors disabled:opacity-50",
                children: [
...
"[project]/src/app/dashboard/bani/[id]/BaniContent.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/app/dashboard/bani/[id]/BaniContent.tsx'\n\nUnexpected token. Did you mean `{'}'}` or `&rbrace;`?");
...
//# sourceMappingURL=_10970513._.js.map